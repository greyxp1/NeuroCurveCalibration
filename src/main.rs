...
mod performance; // Performance optimization and FPS counter
...
use target::{
    ...
    detect_target_hits, update_target_health,
    setup_basic_target_spawner, reset_score_tracker_flags
};
...
use performance::PerformancePlugin; // Import performance optimization and FPS counter
...
fn main() {
    ...
    // Configure the app for better performance
    app
        .add_plugins(DefaultPlugins.set(WindowPlugin {
            primary_window: Some(Window {
                title: "NeuroCurve Aim Trainer".into(),
                resolution: (1280.0, 720.0).into(),
                present_mode: bevy::window::PresentMode::Immediate, // Use immediate mode for better performance
        ...
        // Add our custom UI plugins
        .add_plugins(UiPlugin)
        .add_plugins(PerformancePlugin) // Add performance monitoring and optimization
        ...
        .add_systems(Update, update_score_tracker.after(update_target_health))
        .add_systems(Update, display_score.after(update_score_tracker))
